...
/* 	// Interpolation i marching cubes...
	...
	iso = isovalue
	u = distance between corner and interpolated point (typ.. avståndet mellan hörnet och där triangelns hörn är.) 
	v1, v2 = obtained by central differencing ( verkar typ vara hörnen ) 
